...
module.exports = {
    info: {
        name: "soundcloud",
        description: "To play songs with soundcloud",
        usage: "<Soundcloud_URL>",
        aliases: ["scp"],
    },
    ...
    run: async function (client, message, args) {
        ...
        let songInfo;
        let song;
        if(url.match(/^https?:\/\/(soundcloud\.com)\/(.*)$/gi)) {
            try {
        ...
        const play = async (song) => {
            ...
            if (!song) {
                ...
                message.guild.me.voice.channel.leave(); //If you want your bot stay in vc 24/7 remove this line :)
